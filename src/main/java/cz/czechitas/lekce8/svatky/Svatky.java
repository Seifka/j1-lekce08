...
public class Svatky {
    ...
    public Stream<String> den(MonthDay den) {
        //TODO
        return seznamSvatku().filter(svatek -> svatek.getDen().equals(den))
                .map(svatek -> svatek.getJmeno());
    }
    ...
    public Stream<String> zenskaJmenaVMesici(Month mesic) {
        //TODO
        return seznamSvatku().filter(svatek -> svatek.getDen().getMonth().equals(mesic) && svatek.getGender() == Gender.ZENA)
                .map(svatek -> svatek.getJmeno());
    }
    ...
    public void vypsatJmenaListopad() {
        //TODO
      seznamSvatku().filter(svatek -> svatek.getDen().getMonthValue() == 11)
    ...
    public Stream<String> cervenJmenaOdDesatehoJmena() {
        //TODO
        return seznamSvatku().filter(svatek -> svatek.getDen().getMonthValue() ==6)
                .skip(10)
                .map(svatek -> svatek.getJmeno());
    }
